...
| KWA-1105.11 | no-rights API 403 | kwanr curl POST `/case`, `/suite` | HTTP 403 JSON `{"status":"error","message":"Insufficient rights"}`; read endpoints 200 with `canAssign:false` | PASS |
