...
| 13 | Event Viewer clean | After fixes (93d30a080), reload screen ×3, check events table | No new E_WARNING "Undefined array key is_open"; last event id unchanged | PASS |
