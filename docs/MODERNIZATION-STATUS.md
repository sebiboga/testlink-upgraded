...
>
> Last updated: 2026-09-04 (project info viewer attachment upload/delete closed — `api/projectinfo` `POST upload`/`POST delete` routes + projectInfoView attachments panel, Refs #933, gap from #923)
