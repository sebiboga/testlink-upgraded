    ...
    <span class="clickable" onclick="javascript:toogleShowHide('tsuite_control_panel');" title="{$labels.actions}">{$tlImages.cog}</span>
    ...
    <div id="tsuite_control_panel" style="display:{$tlCfg->gui->op_area_display->test_spec_container};">
      <fieldset class="groupBtn">
        ...
        <form method="post" action="{$basehref}lib/testcases/containerEdit.php">
          ...
          <button type="submit" name="edit_testsuite" id="edit_testsuite" onclick="doAction.value='edit_testsuite'" title="{$labels.btn_edit_testsuite}">{$tlImages.edit}</button>

          <button type="submit" name="move_testsuite_viewer" id="move_testsuite_viewer" onclick="doAction.value='move_testsuite_viewer'" title="{$labels.alt_move_cp_testsuite}">{$tlImages.move_copy}</button>
          
          <button type="submit" name="delete_testsuite" id="delete_testsuite" onclick="doAction.value='delete_testsuite'" title="{$labels.alt_del_testsuite}">{$tlImages.delete}</button>
          ...
          <span onclick="window.open('{$testSuiteDocAction}')" title="{$labels.btn_gen_test_suite_spec_new_window}">{$tlImages.report}</span>

          <span onclick="window.open('{$testSuiteWordDocAction}')" title="{$labels.btn_gen_test_suite_spec_word}">{$tlImages.report_word}</span>

          <span onclick="location='{$importToTSuiteAction}'" title="{$labels.btn_import_testsuite}">{$tlImages.import}</span>
          <span onclick="location='{$tsuiteExportAction}'" title="{$labels.btn_export_testsuite}">{$tlImages.export}</span>
        </form>
      </fieldset>
      ...
      <fieldset class="groupBtn">
        ...
        <form method="post" action="{$basehref}lib/testcases/tcEdit.php">
          ...
          <span onclick="location='{$createTCFromIssueMantisXMLAction}'" title="{$labels.btn_create_from_issue_xml}">{$tlImages.create_from_xml}</span>
        </form>
      </fieldset>
