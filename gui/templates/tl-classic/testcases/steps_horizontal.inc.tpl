...
<div class="workBack">
  ...
  <tr class="nodrag">
    ...
    {if $edit_enabled && $steps != '' && !is_null($steps) && $args_frozen_version=="no"}
      <span class="clickable" align="left" title="{$inc_steps_labels.show_hide_reorder}" onclick="showHideByClass('span','order_info');">{$tlImages.reorder}</span>
      <span class="clickable" align="left" title="{$inc_steps_labels.show_ghost_string}" onclick="showHideByClass('span','ghost');">{$tlImages.ghost_item}</span>
    {/if}
    ...
    {if $inExec}
      <th>{if $tlCfg->exec_cfg->steps_exec_notes_default == 'latest'}{$inc_steps_labels.latest_exec_notes}
          ...
          <span class="clickable" onclick="javascript:clearTextAreaByClassName('step_note_textarea');" title="{$inc_steps_labels.clear_all_notes}">{$tlImages.clear_notes}</span></th>

      <th>{$inc_steps_labels.step_exec_status}
       <span class="clickable" onclick="javascript:clearSelectByClassName('step_status');" title="{$inc_steps_labels.clear_all_status}">{$tlImages.reset}</span></th>
    {/if}    
  </tr>
