      ...
      <table class="simple_tableruler">
      	<tr>
      		<th align="center"  style="width: 5px;background-color:#005498;"> 
      		    <span onclick='cs_all_checkbox_in_div("assigned_cf","assigned_cfield","memory_assigned_cf");' title="{$labels.check_uncheck_all_checkboxes}">{$tlImages.toggle_all}</span>
      		</th>
  ...
  <div class="workBack">
    ...
    <form method="post">
      ...
      <table class="simple_tableruler" style="width: 50%;">
      	<tr>
      		<th align="center"  style="width: 5px;background-color:#005498;"> 
      		    <span onclick='cs_all_checkbox_in_div("free_cf","free_cfield","memory_free_cf");' title="{$labels.check_uncheck_all_checkboxes}">{$tlImages.toggle_all}</span>
      		</th>
      		<th>{$labels.name}</th>
      		<th>{$labels.label}</th>
      		<th>{$labels.type}</th>
