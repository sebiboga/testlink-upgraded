            ...
            <tr>
                ...
                <td>
                    {if $role->dbID > $smarty.const.TL_LAST_SYSTEM_ROLE}
                       <span style="border:none;cursor: pointer;" title="{$labels.alt_delete_role}"
...
>{$tlImages.delete}</span>
          ...
          <span style="border:none;cursor: pointer;" title="{$labels.duplicate_role}" 
>{$tlImages.duplicate}</span>
          </a>
                </td>
