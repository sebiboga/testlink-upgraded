...
<form id='tc_exec_assignment' name='tc_exec_assignment' method='post'>
  ...
  {if $gui->has_tc}
	...
	<div class="groupBtn">
		<div>
			...
			<button class="{#BUTTON_CLASS#}"
              id="checkPlatform" name="checkPlatform"
              onclick="cs_all_checkbox_in_div_with_platform('tc_exec_assignment_cb', '{$add_cb}', 
              jQuery('#select_platform').val()); return false">{$labels.check_uncheck_all_tc}</button>
		</div>
    <br>
      ...
      <select class="chosen-bulk-select" multiple="multiple"
			...
			<input type='button' class="{#BUTTON_CLASS#}"
             name='bulk_user_assignment' 
             id='bulk_user_assignment'
    ...
    <div>
      <input class="{#BUTTON_CLASS#}" type="submit" 
             name="doRemoveAll" id="doRemoveAll" 
             value="{$labels.btn_remove_all_users}" />
      <input class="{#BUTTON_CLASS#}" type="button" 
             name="linkByMail" id="linkByMail" 
 ...
 title="{$labels.execution}">{$tlImages.exec_icon}</span>
              	    		<span class="clickable" 
 ...
 title="{$labels.design}">{$tlImages.edit}</span>
                    ...
                    {else}
                        ...
                        {if $gui->tprojOpt->testPriorityEnabled}<td>&nbsp;</td>{/if}
 ...
 title="{$labels.remove}">{$tlImages.remove}</span> 
