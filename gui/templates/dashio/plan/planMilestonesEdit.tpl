...
@filesource planMilestonesEdit.tpl
*}
  ...
  {include file="inc_update.tpl" user_feedback=$gui->user_feedback}
		      ...
		      <tr>
	            ...
	            <input type="text" 
	                   name="start_date" id="start_date" 
					     ...
					     <img title="{$labels.show_calender}" 
                    src="{$smarty.const.TL_THEME_IMG_DIR}/calendar.gif"
	...
	<div class="groupBtn">
		...
		<input class="{#BUTTON_CLASS#}" type="button" 
           id="go_back" name="go_back" 
           value="{$labels.btn_cancel}" 
           {if $gui->cancelActionJS != ''} 
             onclick="javascript:{$gui->cancelActionJS};"
