          ...
          {if $gui->showMenu != null}
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li><a href="viewer.php?file=testlink_user_manual" target="_blank" rel="noopener"><i class="fas fa-file-pdf"></i> User Manual</a></li>
                <li><a href="viewer.php?file=testlink_installation_manual" target="_blank" rel="noopener"><i class="fas fa-file-pdf"></i> Installation Manual</a></li>

                <li><strong style="padding-left: 10px; font-size: 11px; color: #999; margin-top: 10px;">📚 Reference Guides</strong></li>
                <li><a href="viewer.php?file=tl_file_formats" target="_blank" rel="noopener"><i class="fas fa-file-pdf"></i> File Formats</a></li>
                <li><a href="viewer.php?file=excel2testlink" target="_blank" rel="noopener"><i class="fas fa-file-pdf"></i> Excel Import</a></li>
                <li><a href="viewer.php?file=fckeditor_config" target="_blank" rel="noopener"><i class="fas fa-file-pdf"></i> FCKEditor Config</a></li>
                <li><a href="viewer.php?file=tl_bts_howto" target="_blank" rel="noopener"><i class="fas fa-file-pdf"></i> Bug Tracking HowTo</a></li>
