        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          {if $gui->showMenu != null}
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                <li><a href="lib/docs/viewer.php?file=testlink_user_manual" target="mainframe"><i class="fas fa-file-pdf" style="margin-right: 6px; color: #e74c3c;"></i> {$labels.doc_user_manual}</a></li>
                <li><a href="lib/docs/viewer.php?file=testlink_installation_manual" target="mainframe"><i class="fas fa-file-pdf" style="margin-right: 6px; color: #e74c3c;"></i> {$labels.doc_installation_manual}</a></li>
                <li><a href="lib/docs/viewer.php?file=tl_file_formats" target="mainframe"><i class="fas fa-file-pdf" style="margin-right: 6px; color: #e74c3c;"></i> {$labels.doc_file_formats}</a></li>
                <li><a href="lib/docs/viewer.php?file=excel2testlink" target="mainframe"><i class="fas fa-file-pdf" style="margin-right: 6px; color: #e74c3c;"></i> {$labels.doc_excel_import}</a></li>
                <li><a href="lib/docs/viewer.php?file=fckeditor_config" target="mainframe"><i class="fas fa-file-pdf" style="margin-right: 6px; color: #e74c3c;"></i> {$labels.doc_fckeditor_config}</a></li>
                <li><a href="lib/docs/viewer.php?file=tl_bts_howto" target="mainframe"><i class="fas fa-file-pdf" style="margin-right: 6px; color: #e74c3c;"></i> {$labels.doc_bug_tracking_howto}</a></li>
