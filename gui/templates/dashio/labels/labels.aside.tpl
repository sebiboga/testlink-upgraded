...
{lang_get 
  ...
  s='title_product_mgmt,href_tproject_management,href_admin_modules,
   ...
   href_test_strategy_overview,href_test_strategy_scope,href_test_strategy_exit_criteria,href_issuetracker_management,projects,system,tests_design,requirements_design,
