...
{else}
 ...
 title="{$labels.design}">{$tlImages.edit_icon}</span>
    ...
    {else}
		<div>
			<input class="{#BUTTON_CLASS#}" type="submit" 
             name="do_move_tcase_set" id="do_move_tcase_set"
             value="{$labels.btn_move}"
             onclick="return check_action_precondition('move_copy_checkboxes','move','{$check_msg}');"  />

			<input class="{#BUTTON_CLASS#}" type="submit" 
             name="do_copy_tcase_set" id="do_copy_tcase_set"
             value="{$labels.btn_cp}"
			       onclick="return check_action_precondition('move_copy_checkboxes','copy','{$check_msg}');"  />

      <input class="{#BUTTON_CLASS#}" type="submit" 
             name="do_copy_tcase_set_ghost" id="do_copy_tcase_set_ghost"
             value="{$labels.btn_copy_ghost_zone}"
             onclick="return check_action_precondition('move_copy_checkboxes','copy','{$check_msg}');"  />

			<input type="hidden" 
             name="old_containerID" value="{$old_containerID}" />
		</div>
    {/if}
	</form>
{/if}
