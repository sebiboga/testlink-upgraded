...
*}
{include file="tcViewViewer.labels.tpl"}
...
{$printTestCaseAction="gui/templates/testcases/tcPrint.html?tproject_id=$tproject_id&tplan_id=$tplan_id"}
...
{if $gui->requirementsEnabled == TRUE && 
 ...
 title="{$tcView_viewer_labels.link_unlink_requirements}">{$tlImages.item_link}</span>
              {/if}
              : &nbsp;</span>
        </td>
        <td>
 ...
 title="{$tcView_viewer_labels.requirement}">{$tlImages.edit}</span>
