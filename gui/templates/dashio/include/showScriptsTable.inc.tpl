    ...
    <tr>
      ...
      {if $can_delete}
        <td class="clickable_icon">
          <span class="clickable" onclick="delete_confirmation('{$tproject_id}:{$item_id}-{$script_id|escape:'javascript'|escape}','{$script_id|escape:'javascript'|escape}',
 '{$l10nb.delete_script}','{$l10nb.del_script_warning_msg} ({$l10nb.script_id} {$script_id})',deleteScript);" style="border:none" title="{$l10nb.delete_script}" 
